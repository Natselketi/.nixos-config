{
  ...
  inputs = {
    ...
    millennium.url = "github:SteamClientHomebrew/Millennium?dir=packages/nix&ref=e2c66a276e579ee73c5151b01897bf63503aa12c";
    ...
    forkprince = { url = "github:ForkPrince/nur-packages"; inputs.nixpkgs.follows = "nixpkgs"; };
  };
